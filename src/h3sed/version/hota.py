...
CREATURE_LEVELS = {
    "Bulwark": [
        ["Kobold", "Kobold Foreman"],
        ["Mountain Ram", "Argali"],
        ["Snow Elf", "Steel Elf"],
        ["Yeti", "Yeti Runemaster"],
        ["Shaman", "Great Shaman"],
        ["Mammoth", "War Mammoth"],
    ...
    "Factory": [
        ["Halfling", "Halfling Grenadier"],
        ["Mechanic", "Engineer"],
        ["Armadillo", "Bellwether Armadillo"],
        ["Automaton", "Sentinel Automaton"],
        ["Sandworm", "Olgoi-Khorkhoi"],
        ["Gunslinger", "Bounty Hunter"],
        ["Couatl", "Crimson Couatl"],
